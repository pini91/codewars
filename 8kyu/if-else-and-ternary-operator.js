// n JavaScript, if..else is the most basic conditional statement, it consists of three parts:condition, statement1, statement2, like this:
...
function saleHotdogs(n){
    let pricePerUnite= (n<5)? 100: (n>=5&&n<10)? 95: 90
    return pricePerUnite*n
}
