...
//Your function should not mutate the input array, and this will be tested (where applicable). Notice that the returned list will always be of odd size, 
...
function mirror(data) {
    ...
    let sortedReversed= sorted.slice(0,-1).reverse()
    console.log(sorted.concat(sortedReversed))


    // let sorted = [...data].sort((a,b)=> a-b) //...data is to not mutate the original list.
